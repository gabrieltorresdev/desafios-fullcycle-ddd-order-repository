...
describe("Order repository test", () => {
  ...
  it("should create and update an order", async () => {
    ...
    const addressCustomer2 = new Address("Street 2", 2, "Zipcode 2", "City 2");
    customer2.changeAddress(addressCustomer2);
  ...
  it("should find and return an order", async () => {
    const customerRepository = new CustomerRepository();
    const customer = new Customer("123", "Customer 1");
    const address = new Address("Street 1", 1, "Zipcode 1", "City 1");
    customer.changeAddress(address);
  ...
  it("should find all orders", async () => {
    ...
    const product2 = new Product("1234", "Product 2", 45);
    await productRepository.create(product2);
    ...
    const order2 = new Order("1234", "1234", [order2Item]);
